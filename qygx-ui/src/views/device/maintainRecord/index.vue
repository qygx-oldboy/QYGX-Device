<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="maintainSheetList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键id" align="center" prop="maintainSheetId" />
      <el-table-column label="保养工单" align="center" prop="sheetNumber" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAddDeviceMaintainDetail">添加</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="handleDeleteDeviceMaintainDetail">删除</el-button>
          </el-col>
        </el-row>
        <el-table :data="deviceMaintainDetailList" :row-class-name="rowDeviceMaintainDetailIndex" @selection-change="handleDeviceMaintainDetailSelectionChange" ref="deviceMaintainDetail">
          ...
          <el-table-column label="计划详情id" prop="planDetailId" width="150">
            <template slot-scope="scope">
              <el-input v-model="scope.row.planDetailId" placeholder="请输入计划详情id" />
            </template>
          </el-table-column>
          <el-table-column label="状态(0正常 1不正常 2修复)" prop="isNormal" width="150">
            <template slot-scope="scope">
...
<script>
import { listMaintainSheet, getMaintainSheet, delMaintainSheet, addMaintainSheet, updateMaintainSheet } from "@/api/device/maintainRecord";
